  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @selectTrademark="selectTrademark" @selectAttrs="selectAttrs"></SearchSelector>
        <!--details-->
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isComplexOrder}" @click="changeOrder('1')">
                  <a>
                    综合
                    <span v-show="isComplexOrder">{{isAsc ? "↑":"↓"}}</span>
                  </a>
                </li>
                <li :class="{active: isPriceOrder}" @click="changeOrder('2')">
                  <a>
                    价格
                    <span v-show="isPriceOrder">{{isAsc ? "↑":"↓"}}</span>
                  </a>
                </li>
              </ul>
            </div>
